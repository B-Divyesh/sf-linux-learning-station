...
- Live cold check after Azure Static Web Apps deployment `70a32c8d-5506-4c21-843c-01505d3ed86c`: `/` has the plain title, h1, four facts, and main; `/?demo=1` has the banner and six activities; a fresh `/activity/patterns` opens Pattern Quarry after age selection with matching canonical/OG/title; Privacy metadata is correct; `/unknown-polish-route` returns the designed 404 with status 404 and legal links.
